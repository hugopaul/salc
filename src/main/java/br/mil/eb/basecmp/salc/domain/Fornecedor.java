...
@AllArgsConstructor
@Builder
@Table(uniqueConstraints = @UniqueConstraint(columnNames = {"id", "id_empenho"}))
public class Fornecedor {
    ...
    @Column(nullable = false)
    @NotNull(message = "Selecione MEIO DE CONTATO com o Fornecedor!")
    private Integer meioContato;
